...
" hi VisualNOS
hi Search cterm=none ctermfg=235 ctermbg=yellow
...
hi StatusLine	ctermfg=7		ctermbg=236		cterm=none		guifg=#f6f3e8	guibg=#444444	gui=italic
hi VertSplit	ctermfg=236		ctermbg=235		cterm=none		guifg=#444444	guibg=#444444	gui=none
hi StatusLineNC	ctermfg=243		ctermbg=238		cterm=none		guifg=#857b6f	guibg=#444444	gui=none
hi LineNr		ctermfg=240		ctermbg=232	cterm=none		guifg=#857b6f	guibg=#000000	gui=none
